...
public class SecurityPolicyRewriteRule {
     ...
     * Deferred statements such as PREPARE stay opaque; their executable inner statement is
     * marked explicitly at the PREPARE metadata and EXECUTE boundaries.
     */
     ...
     */
    public static boolean hasPolicy(ConnectContext context, StatementBase statement) {
